...
object Notice {
  ...
  sealed trait Consumer[+C[+U] <: Consumer[C, U], +T] {
    ...
    private[Notice] def failureReporter: FailureReporter
  ...
  final class Stream[+T] private (private[Notice] val failureReporter: FailureReporter)
  ...
  final class Steady[+T] private (private[Notice] val failureReporter: FailureReporter)
  ...
  final class Varying[+T] private (private[Notice] val failureReporter: FailureReporter)
